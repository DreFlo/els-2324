...
public class InternalTableDSLLexer extends Lexer {
    ...
    public final void mRULE_SELECTOR_KEYWORDS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4389:24: ( ( 'MAX' | 'MIN' | 'MEDIAN' | 'SUM' | 'AVG' ) )
            // InternalTableDSL.g:4389:26: ( 'MAX' | 'MIN' | 'MEDIAN' | 'SUM' | 'AVG' )
            {
            // InternalTableDSL.g:4389:26: ( 'MAX' | 'MIN' | 'MEDIAN' | 'SUM' | 'AVG' )
            int alt1=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalTableDSL.g:4389:27: 'MAX'
                    {
                    match("MAX"); 
                    ...
                    break;
                case 2 :
                    // InternalTableDSL.g:4389:33: 'MIN'
                    {
                    match("MIN"); 
                    ...
                    break;
                case 3 :
                    // InternalTableDSL.g:4389:39: 'MEDIAN'
                    {
                    match("MEDIAN"); 
                    ...
                    break;
                case 4 :
                    // InternalTableDSL.g:4389:48: 'SUM'
                    {
                    match("SUM"); 
                    ...
                    break;
                case 5 :
                    // InternalTableDSL.g:4389:54: 'AVG'
                    {
                    match("AVG"); 
    ...
    public final void mRULE_OBJECT_TYPES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4391:19: ( ( 'STRING' | 'NUMBER' | 'INTEGER' | 'FLOAT' | 'DOUBLE' | 'BOOLEAN' ) )
            // InternalTableDSL.g:4391:21: ( 'STRING' | 'NUMBER' | 'INTEGER' | 'FLOAT' | 'DOUBLE' | 'BOOLEAN' )
            {
            // InternalTableDSL.g:4391:21: ( 'STRING' | 'NUMBER' | 'INTEGER' | 'FLOAT' | 'DOUBLE' | 'BOOLEAN' )
            int alt2=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt2) {
                case 1 :
                    // InternalTableDSL.g:4391:22: 'STRING'
                    {
                    match("STRING"); 
                    ...
                    break;
                case 2 :
                    // InternalTableDSL.g:4391:31: 'NUMBER'
                    {
                    match("NUMBER"); 
                    ...
                    break;
                case 3 :
                    // InternalTableDSL.g:4391:40: 'INTEGER'
                    {
                    match("INTEGER"); 
                    ...
                    break;
                case 4 :
                    // InternalTableDSL.g:4391:50: 'FLOAT'
                    {
                    match("FLOAT"); 
                    ...
                    break;
                case 5 :
                    // InternalTableDSL.g:4391:58: 'DOUBLE'
                    {
                    match("DOUBLE"); 
                    ...
                    break;
                case 6 :
                    // InternalTableDSL.g:4391:67: 'BOOLEAN'
                    {
                    match("BOOLEAN"); 
    ...
    public final void mRULE_COLUMN_NAME_KEYWORDS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4393:27: ( ( 'FILENAME' | 'DIRECTORY' ) )
            // InternalTableDSL.g:4393:29: ( 'FILENAME' | 'DIRECTORY' )
            {
            // InternalTableDSL.g:4393:29: ( 'FILENAME' | 'DIRECTORY' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalTableDSL.g:4393:30: 'FILENAME'
                    {
                    match("FILENAME"); 
                    ...
                    break;
                case 2 :
                    // InternalTableDSL.g:4393:41: 'DIRECTORY'
                    {
                    match("DIRECTORY"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4395:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalTableDSL.g:4395:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalTableDSL.g:4395:11: ( '^' )?
            int alt4=2;
            ...
            // InternalTableDSL.g:4395:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4397:10: ( ( '0' .. '9' )+ )
            // InternalTableDSL.g:4397:12: ( '0' .. '9' )+
            {
            // InternalTableDSL.g:4397:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalTableDSL.g:4397:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4399:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalTableDSL.g:4399:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalTableDSL.g:4399:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalTableDSL.g:4399:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalTableDSL.g:4399:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalTableDSL.g:4399:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalTableDSL.g:4399:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4401:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTableDSL.g:4401:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTableDSL.g:4401:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4403:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTableDSL.g:4403:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalTableDSL.g:4403:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4405:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTableDSL.g:4405:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTableDSL.g:4405:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTableDSL.g:4407:16: ( . )
            // InternalTableDSL.g:4407:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\1\uffff\5\41\1\uffff\20\41\1\36\2\uffff\3\36\2\uffff\2\41\1\uffff\2\41\1\115\1\41\1\117\3\41\1\uffff\7\41\1\133\1\41\1\136\17\41\5\uffff\4\41\1\uffff\1\41\1\uffff\13\41\1\uffff\2\41\1\uffff\1\u0080\1\41\2\u0082\1\41\1\u0082\1\41\1\u0082\14\41\1\u0091\1\41\1\u0093\1\41\1\u0095\3\41\1\u0099\4\41\1\uffff\1\u009e\1\uffff\15\41\1\u00ac\1\uffff\1\41\1\uffff\1\41\1\uffff\3\41\1\uffff\4\41\1\uffff\4\41\1\u00ba\4\41\1\u00c0\1\u00c1\1\u00c3\1\u00c4\1\uffff\1\u00c5\1\u00c6\1\u00c7\1\u00c8\1\u00c9\1\41\1\u00cb\1\41\1\u00cd\1\u0082\2\u00ba\1\41\1\uffff\1\41\1\u00ba\2\41\1\u00d2\2\uffff\1\u00d3\7\uffff\1\u00d4\1\uffff\1\u00d5\1\uffff\1\u00ba\2\41\1\u00ba\4\uffff\1\u00d8\1\41\1\uffff\1\u00d8";
    static final String DFA15_eofS =
        "\u00da\uffff";
    static final String DFA15_minS =
        "\1\0\1\157\1\142\1\141\1\151\1\157\1\uffff\2\145\1\162\1\160\1\170\1\171\1\117\1\145\1\101\1\124\1\126\1\125\1\116\2\111\1\117\1\101\2\uffff\2\0\1\52\2\uffff\1\154\1\145\1\uffff\1\152\1\164\1\60\1\142\1\60\1\157\1\154\1\141\1\uffff\1\154\1\162\1\165\1\144\1\167\1\145\1\160\1\60\1\143\1\60\1\120\1\156\1\130\1\116\1\104\1\115\1\122\1\107\1\115\1\124\1\117\1\114\1\125\1\122\1\117\5\uffff\1\165\1\141\1\145\1\160\1\uffff\1\154\1\uffff\1\155\1\164\1\144\1\145\1\164\2\141\1\165\1\163\1\160\1\145\1\uffff\1\162\1\145\1\uffff\1\60\1\171\2\60\1\111\1\60\1\111\1\60\1\102\1\105\1\101\1\105\1\102\1\105\1\114\1\155\1\164\1\143\1\165\1\145\1\60\1\145\1\60\1\143\1\60\1\163\1\155\1\143\1\60\1\145\1\156\1\141\1\160\1\uffff\1\60\1\uffff\1\101\1\116\1\105\1\107\1\124\1\116\1\114\1\103\1\105\1\156\1\145\2\164\1\60\1\uffff\1\162\1\uffff\1\164\1\uffff\1\150\2\145\1\uffff\1\156\1\144\1\143\1\164\1\uffff\1\116\1\107\1\122\1\105\1\60\1\101\1\105\1\124\1\101\4\60\1\uffff\5\60\1\144\1\60\1\164\4\60\1\122\1\uffff\1\115\1\60\1\117\1\116\1\60\2\uffff\1\60\7\uffff\1\60\1\uffff\1\60\1\uffff\1\60\1\105\1\122\1\60\4\uffff\1\60\1\131\1\uffff\1\60";
    static final String DFA15_maxS =
        "\1\uffff\1\162\1\165\1\157\1\162\1\157\1\uffff\1\161\1\157\1\162\1\163\1\170\1\171\1\117\1\145\1\111\1\125\1\126\1\125\1\116\1\114\2\117\1\172\2\uffff\2\uffff\1\57\2\uffff\1\154\1\145\1\uffff\1\152\1\164\1\172\1\142\1\172\1\157\1\154\1\141\1\uffff\1\154\1\162\1\165\1\156\1\167\1\145\1\160\1\172\1\164\1\172\1\120\1\156\1\130\1\116\1\104\1\115\1\122\1\107\1\115\1\124\1\117\1\114\1\125\1\122\1\117\5\uffff\1\165\1\141\1\145\1\160\1\uffff\1\154\1\uffff\1\155\1\164\1\144\1\145\1\164\2\141\1\165\1\163\1\160\1\145\1\uffff\1\162\1\145\1\uffff\1\172\1\171\2\172\1\111\1\172\1\111\1\172\1\102\1\105\1\101\1\105\1\102\1\105\1\114\1\155\1\164\1\143\1\165\1\145\1\172\1\145\1\172\1\143\1\172\1\163\1\155\1\143\1\172\1\145\1\156\1\141\1\160\1\uffff\1\172\1\uffff\1\101\1\116\1\105\1\107\1\124\1\116\1\114\1\103\1\105\1\156\1\145\2\164\1\172\1\uffff\1\162\1\uffff\1\164\1\uffff\1\150\2\145\1\uffff\1\156\1\144\1\143\1\164\1\uffff\1\116\1\107\1\122\1\105\1\172\1\101\1\105\1\124\1\101\4\172\1\uffff\5\172\1\144\1\172\1\164\4\172\1\122\1\uffff\1\115\1\172\1\117\1\116\1\172\2\uffff\1\172\7\uffff\1\172\1\uffff\1\172\1\uffff\1\172\1\105\1\122\1\172\4\uffff\1\172\1\131\1\uffff\1\172";
    static final String DFA15_acceptS =
        "\6\uffff\1\11\21\uffff\1\37\1\40\3\uffff\1\44\1\45\2\uffff\1\37\10\uffff\1\11\31\uffff\1\40\1\41\1\42\1\43\1\44\4\uffff\1\32\1\uffff\1\13\13\uffff\1\23\2\uffff\1\22\41\uffff\1\24\1\uffff\1\34\16\uffff\1\7\1\uffff\1\10\1\uffff\1\21\3\uffff\1\26\4\uffff\1\30\15\uffff\1\6\15\uffff\1\35\5\uffff\1\1\1\5\1\uffff\1\3\1\12\1\27\1\14\1\25\1\15\1\33\1\uffff\1\17\1\uffff\1\31\4\uffff\1\2\1\4\1\16\1\20\2\uffff\1\36\1\uffff";
    static final String DFA15_specialS =
        "\1\0\31\uffff\1\1\1\2\u00be\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\36\2\35\2\36\1\35\22\36\1\35\1\36\1\32\4\36\1\33\4\36\1\6\2\36\1\34\12\31\7\36\1\21\1\26\1\30\1\25\1\30\1\24\2\30\1\23\3\30\1\17\1\22\4\30\1\20\1\15\6\30\3\36\1\27\1\30\1\36\1\12\1\14\1\1\1\16\1\13\1\4\5\30\1\5\2\30\1\2\1\11\1\30\1\10\1\7\1\3\6\30\uff85\36",
            "\1\37\2\uffff\1\40",
            "\1\42\3\uffff\1\44\16\uffff\1\43",
            "\1\45\15\uffff\1\46",
            "\1\50\10\uffff\1\47",

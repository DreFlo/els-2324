...
public class TableDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TableDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getObjectTypeSelectorAccess().getObjectTypeAlternatives_0(), "rule__ObjectTypeSelector__ObjectTypeAlternatives_0");
			...
			builder.put(grammarAccess.getExtractColumnMappingAccess().getGroup_1(), "rule__ExtractColumnMapping__Group_1__0");
			builder.put(grammarAccess.getTopNSelectorAccess().getGroup(), "rule__TopNSelector__Group__0");
			...
			builder.put(grammarAccess.getExtractColumnMappingAccess().getTargetColumnAssignment_0(), "rule__ExtractColumnMapping__TargetColumnAssignment_0");
			builder.put(grammarAccess.getExtractColumnMappingAccess().getNewNameAssignment_1_1(), "rule__ExtractColumnMapping__NewNameAssignment_1_1");
			builder.put(grammarAccess.getKeySelectorAccess().getKeyAssignment(), "rule__KeySelector__KeyAssignment");
			builder.put(grammarAccess.getTopNSelectorAccess().getNAssignment_1(), "rule__TopNSelector__NAssignment_1");
			...
			builder.put(grammarAccess.getObjectTypeSelectorAccess().getObjectTypeAssignment(), "rule__ObjectTypeSelector__ObjectTypeAssignment");
		}
	}
